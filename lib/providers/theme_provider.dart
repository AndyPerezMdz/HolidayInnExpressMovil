...
class ThemeProvider extends ChangeNotifier {
  ...
  final Map<String, Map<String, String>> _translations = {
    'Español': {
      ...
      'tutorial_checkin_desc': 'Toca el código QR para simular el check-in o check-out',
    ...
    'English': {
      ...
      'security': 'Security',
      'tutorial_checkin_desc': 'Tap the QR code to simulate check-in or check-out.',
